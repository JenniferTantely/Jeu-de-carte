...
function tuto(){
    ...
    console.log("- Carte du feu (taper f): Qui peut vaincre la carte de la plante, mais vaincue par la carte de l'eau.");
    console.log("- Carte de l'eau (taper e): Qui peut vaincre la carte du feu, mais vaincue par la carte de la plante.");
    console.log("- Carte de la plante (taper p): Qui peut vaincre la carte de l'eau, mais vaincue par la carte du feu.");
    console.log("");
